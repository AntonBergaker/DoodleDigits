...
static class VectorFunctions {
    ...
    public static Value Magnitude(Value value, ExecutionContext context, Function node) {
        if (value is MatrixValue matrix) {
            if (matrix.DimensionCount == 1) {
    ...
    public static Value Determinant(Value value, ExecutionContext context, Function node) {
        if (value is MatrixValue matrix) {
    ...
    public static Value Projection(Value value, Value @base, ExecutionContext context, Function node) {
